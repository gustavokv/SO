...
/* Nota para Professor Fabrício */
/* 
    O código com 1 milhão de elementos demorou cerca de 30 minutos para encerrar.
    Ele retornou o resultado correto, tenho o arquivo resultante no meu PC e também um print do comando
    diff para verificar se o arquivo resultante e o "1000000.out.txt são iguais e resultou que são. Grato.
*/
...
void* l3_runner(void *param){
    ...
    do{
        /* Aguarda ser liberado pelo l2_runner */
        sem_wait(sem2);
        ...
        if(auxL2 && result == 0){
            ...
            /* Libera a l3_print_runner para executar */
            sem_post(sem3);
        }
    }while(auxL2);
...
void* l3_print_runner(void *param){
    ...
    do{
        /* Aguarda ser liberado pelo l3_runner */
        sem_wait(sem3);
